...
class PatientDetailsScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    // --------------------------------
    // FutureBuilder para cargar avatar desde Storage
                  ...
                  child: Row(
                    children: [
                      ...
                      CircleAvatar(
                        ...
                        backgroundColor:
                            avatarUrl.isEmpty ? AppColors.accent3 : Colors.transparent,
                        ...
                        return Padding(
                          ...
                          child: GestureDetector(
                            onTap: () {
                              ...
                              DateTime? birthDate;
                              final rawBirthInner = data['fechaNacimiento'];
                              if (rawBirthInner is Timestamp) {
                                birthDate = rawBirthInner.toDate();
                              } else if (rawBirthInner is String) {
                                // Attempt to parse string-formatted date "dd/MM/yyyy"
                                try {
                                  final parts = rawBirthInner.split('/');
                                  birthDate = DateTime(
                                    int.parse(parts[2]),
                                    int.parse(parts[1]),
                                    int.parse(parts[0]),
